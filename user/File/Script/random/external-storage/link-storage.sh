...
mkdir -p "$HOME/File/Software/Podman"
mkdir -p "$HOME/File/Software/VM"
...
ln -sfn "$BASE/Main/File/Software/Podman" "$HOME/File/Software/Podman/Podman-$NAME"
ln -sfn "$BASE/Main/File/Software/VM"     "$HOME/File/Software/VM/VM-$NAME"
